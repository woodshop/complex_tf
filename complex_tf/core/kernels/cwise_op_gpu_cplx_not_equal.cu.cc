...
namespace pycuda {
  ...
  __global__ void CplxNotEqualKernel(const complex<float> *in1,
...
namespace tensorflow {
  ...
  namespace functor {
    ...
    DEFINE_BINARY1(cplx_not_equal, complex64);
